...
import com.leviathanstudio.lib.asm.LSLHook;
...
public class ContainerPlayer extends Container
{
    ...
    public void onCraftMatrixChanged(IInventory inventoryIn)
    {
        ...
        this.craftResult.setInventorySlotContents(0,
                LSLHook.onCraftMatrixChanged(this.thePlayer, this.thePlayer.worldObj, this.craftMatrix));
        // LSLHook.onCraftMatrixChanged(this.thePlayer, this.thePlayer.worldObj,
